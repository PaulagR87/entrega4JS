window.onload = function(){
    ...
    function showProducts(){
        if(selectElement.value=="Helado"){
            container2.textContent = "chocolate (14.0), vainilla (12.0), frutilla (9.98), limon (6.0), almendrado (7.5)";
        }
        else if (selectElement.value=="Torta"){
            container2.textContent = "chocolate (14.0), vainilla (12.0), frutilla (9.98), limon (6.0)";
        }
    }
